...
class Products extends React.Component{
    ...
    saveProduct(product){
        if(!product.id) product.id = new Date().getTime();
        this.setState((preState) => {
            let products = preState.products;
    ...
    render() {
        return(
            <div>
                <Filters filterText={this.state.filterText} inStockOnly={this.state.inStockOnly} onFilter={this.handleFilter}/>
                <ProductTable products={this.state.products} filterText={this.state.filterText} inStockOnly={this.state.inStockOnly} 
                onDestroy={this.destroyProduct} onEdit={this.editProduct}/>
                <ProductForm onSave={this.saveProduct} edit={this.state.formProduct}/>
            </div>
        );
    }
}
